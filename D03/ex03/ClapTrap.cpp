...
void ClapTrap::meleeAttack(std::string const & target) {
    std::cout << this->getName() << " the inherited ClapTrapper Attacks " << target << " at melee, causing " << this->getRangedAttackDamage() << " damage !" << std::endl;
}

void ClapTrap::rangedAttack(std::string const & target) {
    std::cout << this->getName() << " the inherited ClapTrapper Attacks " << target << " at range, causing " << this->getRangedAttackDamage() << " damage !" << std::endl; 
}
