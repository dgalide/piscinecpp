...
bool        OfficeBlock::isTeamComplete(void) const {
    return (this->intern && this->signingBureaucrat && this->executingBureaucrat);
}

bool        OfficeBlock::isSigningMissing(void) const {
    return !this->signingBureaucrat;
}

bool        OfficeBlock::isExecMissing(void) const {
    return !this->executingBureaucrat;
}

bool        OfficeBlock::isInternMissing(void) const {
    return !this->intern;
}
